...
export default function ResultsPanel(){
  ...
  return (
    <div className="results-root" style={{padding:12, fontFamily:'system-ui, monospace', color:'#E5E7EB'}}>
      <div style={{fontFamily:'monospace', color:'#F9FAFB', marginBottom:10}}>Scan completed · Public sources only</div>

      <div className="rp-section" style={{animationDelay:'150ms'}}>
      ...
      <div className="rp-section" style={{animationDelay:'1050ms'}}>
        <div style={{background:'rgba(255,255,255,0.02)', padding:16, borderRadius:8}}>
